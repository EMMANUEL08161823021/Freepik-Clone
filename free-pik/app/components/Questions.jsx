      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-4">
          <article className="border rounded-lg p-4 bg-white">
            ...
            <h4 className="mt-2 font-semibold text-gray-900">Active Users</h4>
          ...
          <article className="border rounded-lg p-4 bg-white">
            ...
            <h4 className="mt-2 font-semibold text-gray-900">Uptime</h4>
          ...
          <article className="border rounded-lg p-4 bg-white">
            ...
            <h4 className="mt-2 font-semibold text-gray-900">Support</h4>
